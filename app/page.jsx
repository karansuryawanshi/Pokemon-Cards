      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 flex-wrap">
        {pokemons.map((pokemon) => (
          <Link key={pokemon.id} href={`/pokemon/${pokemon.id}`}>
            <div className=" bg-neutral-800/90 p-4 rounded-lg flex flex-col text-center items-center justify-center shadow cursor-pointer hover:scale-105 hover:bg-neutral-800/70 duration-300">
              <Image
                src={pokemon.image}
                alt={pokemon.name}
                width={150}
